...
new = ag(new, "Feel that people are against me", "Often feel that others laugh or talk about me", rev2 = T)
...
new = ag(new, "Make friends easily", "Am skilled in handling social situations")
...
new = ag(new, "Rebel against authority", "Respect authority")
...
new = ag(new, "Have strong sexual urges", "Dont think much about sex")
