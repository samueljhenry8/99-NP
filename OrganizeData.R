...
part1comb = part1comb %>% filter(`PID` %in% part1all$PID)
part2comb = part2comb %>% filter(`PID` %in% part2all$PID)
...
rm(list = ls()[!ls() %in% c("part1all","part2all", "outcomesR", "part1comb", "part2comb")])
